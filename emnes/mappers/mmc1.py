...
class MMC1(MapperBase):
    ...
    __slots__ = [
        ...
        "_8000_bank_offset",
        "_C000_bank_offset",
        # We need to keep track of the current register because
        # changing register during the write sequence to it
        # resets the sequence and count to 0.
        "_current_register",
    ...
    def write_rom_byte(self, addr, value):
        ...
        # If we changed register, we have to reset the count.
        if register != self._current_register:
            self._register_value = 0b10000

        self._current_register = register
        ...
        is_final_write = self._register_value & 0x1
